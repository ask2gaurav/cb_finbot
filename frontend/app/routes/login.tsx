...
const DEMO_ACCOUNTS = [
  ...
  { role: "engineering", email: "engineering@demo.com" },
  { role: "marketing", email: "marketing@demo.com" },
  { role: "employee", email: "employee@demo.com" },
  { role: "c_level", email: "c_level@demo.com" },
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              {DEMO_ACCOUNTS.map((acc) => (
                <button
                  ...
                  onClick={() => {
                    setEmail(acc.email);
                    setPassword(acc.role === 'admin' ? 'admin123' : 'demo123');
                  }}
